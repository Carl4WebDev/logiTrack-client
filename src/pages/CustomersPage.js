...
import ErrorModal from "../components/ErrorModal/ErrorModal"; // Add with other imports
const ShipmentsPage = () => {
  ...
  return (
    <div className="p-5">
      ...
      <div className="flex justify-between items-center mb-4 ">
        <h2 className="text-3xl text-white font-bold">Customer</h2>
        <button
          ...
          <div className="bg-white w-3/5 max-h-[80vh] p-6 rounded-lg overflow-y-auto">
            ...
            <div className="mt-4 flex justify-end gap-2">
              <button
                ...
                onClick={async () => {
                  try {
                    await handleCreateNew(newCustomer);
