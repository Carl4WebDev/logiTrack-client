...
const ItemActivityLogPage = () => {
  ...
  const {
    ...
    handleCreateNew,
    saveExcelData,
  } = useItemActivityLogContext();

  // State for modal visibility and form inputs
  const [isModalOpen, setIsModalOpen] = useState(false);
  const [newItemActivityLog, setNewItemActivityLog] = useState({
    name: "",
    description: "",
  ...
  const handleSaveExcelData = async () => {
    try {
      const updatedItemActivityLog = await saveExcelData(
        selectedExcelId,
        excelTableData,
        excelFileName
      );
      ...
      setItemActivityLogData((prev) =>
        prev.map((item) =>
          item.id === updatedItemActivityLog.id
            ? { ...item, ...updatedItemActivityLog }
            : item
        )
      );
  ...
  const filteredData = itemActivityLogData.filter((row) => {
  ...
  return (
    <div className="p-5">
      ...
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-3xl text-white font-bold">Item Activity Log</h2>
        <button
      ...
      {/* Modal for Adding New Item Activity Log */}
      {isModalOpen && (
          ...
          <div className="bg-white w-3/5 max-h-[80vh] p-6 rounded-lg overflow-y-auto">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  type="text"
                  name="name"
                  value={newItemActivityLog.name}
                  onChange={(e) =>
                    setNewItemActivityLog({
                      ...newItemActivityLog,
                      name: e.target.value,
                    })
                  }
              ...
              <div>
                ...
                <input
                  type="text"
                  name="createdBy"
                  value={newItemActivityLog.createdBy}
                  onChange={(e) =>
                    setNewItemActivityLog({
                      ...newItemActivityLog,
              ...
              <div className="col-span-2">
                ...
                <textarea
                  name="description"
                  value={newItemActivityLog.description}
                  onChange={(e) =>
                    setNewItemActivityLog({
                      ...newItemActivityLog,
              ...
              <div>
                ...
                <select
                  name="status"
                  value={newItemActivityLog.status}
                  onChange={(e) =>
                    setNewItemActivityLog({
                      ...newItemActivityLog,
            ...
            <div className="mt-4 flex justify-end gap-2">
              <button
                ...
                onClick={async () => {
                  try {
                    await handleCreateNew(newItemActivityLog);
...
export default ItemActivityLogPage;
