...
const ItemSnapshotsPage = () => {
  ...
  const {
    ...
    handleCreateNew,
    saveExcelData,
  } = useItemSnapshotContext();

  // State for modal visibility and form inputs
  const [isModalOpen, setIsModalOpen] = useState(false);
  const [newItemSnapshot, setNewItemSnapshot] = useState({
    name: "",
    description: "",
  ...
  const handleSaveExcelData = async () => {
    try {
      const updatedSnapshot = await saveExcelData(
        selectedExcelId,
        excelTableData,
        excelFileName
      );
  ...
  const filteredData = itemSnapshotsData.filter((row) => {
  ...
  return (
    <div className="p-5">
      ...
      <div className="flex justify-between items-center mb-4 ">
        <h2 className="text-3xl text-white font-bold">Item Snapshots</h2>
        <button
          ...
          <div className="bg-white w-3/5 max-h-[80vh] p-6 rounded-lg overflow-y-auto">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  type="text"
                  name="createdBy"
                  value={newItemSnapshot.createdBy}
                  onChange={(e) =>
                    setNewItemSnapshot({
                      ...newItemSnapshot,
              ...
              <div className="col-span-2">
                ...
                <textarea
                  name="description"
                  value={newItemSnapshot.description}
                  onChange={(e) =>
                    setNewItemSnapshot({
                      ...newItemSnapshot,
            ...
            <div className="mt-4 flex justify-end gap-2">
              <button
                ...
                onClick={async () => {
                  try {
                    await handleCreateNew(newItemSnapshot);
