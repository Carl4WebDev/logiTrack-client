...
const DispatchOutputPage = () => {
  ...
  const {
    ...
    handleCreateNew,
    saveExcelData,
  } = useDispatchOutputContext();
  // State for modal visibility and form inputs
  const [isModalOpen, setIsModalOpen] = useState(false);
  const [newDispatchOutput, setNewDispatchOutput] = useState({
    name: "",
    description: "",
  ...
  const handleSaveExcelData = async () => {
    try {
      const updatedDispatchOutput = await saveExcelData(
        selectedExcelId,
        excelTableData,
        excelFileName
      );
      ...
      setDispatchOutputData((prev) =>
        prev.map((dispatchOutput) =>
          dispatchOutput.id === updatedDispatchOutput.id
            ? { ...dispatchOutput, ...updatedDispatchOutput }
            : dispatchOutput
        )
      );
  ...
  const filteredData = dispatchOutputData.filter((row) => {
  ...
  return (
    <div className="p-5">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-3xl text-white font-bold">Dispatch Outputs</h2>
        <button
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
          <div className="bg-white w-3/5 max-h-[80vh] p-6 rounded-lg overflow-y-auto">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-xl font-bold">New Dispatch Output</h2>
              <button
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  type="text"
                  name="name"
                  value={newDispatchOutput.name}
                  onChange={(e) =>
                    setNewDispatchOutput({
                      ...newDispatchOutput,
                      name: e.target.value,
                    })
                  }
              ...
              <div>
                ...
                <input
                  type="text"
                  name="createdBy"
                  value={newDispatchOutput.createdBy}
                  onChange={(e) =>
                    setNewDispatchOutput({
                      ...newDispatchOutput,
              ...
              <div className="col-span-2">
                ...
                <textarea
                  name="description"
                  value={newDispatchOutput.description}
                  onChange={(e) =>
                    setNewDispatchOutput({
                      ...newDispatchOutput,
              ...
              <div>
                ...
                <select
                  name="status"
                  value={newDispatchOutput.status}
                  onChange={(e) =>
                    setNewDispatchOutput({
                      ...newDispatchOutput,
            ...
            <div className="mt-4 flex justify-end gap-2">
              <button
                ...
                onClick={async () => {
                  try {
                    await handleCreateNew(newDispatchOutput);
...
export default DispatchOutputPage;
