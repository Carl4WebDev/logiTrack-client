...
const DriverPage = () => {
    ...
    const fetchDrivers = async () => {
      try {
        const response = await fetch(
          "https://logitrack-serverz.onrender.com/api/drivers"
        );
        if (!response.ok) {
  ...
  const handleDelete = async (id) => {
    try {
      const response = await fetch(
        `https://logitrack-serverz.onrender.com/api/drivers/${id}`,
        {
          method: "DELETE",
        }
      );
  ...
  const handleSave = async () => {
    try {
      const response = await fetch(
        `https://logitrack-serverz.onrender.com/api/drivers/${selectedDriver.id}`,
        {
          method: "PUT",
  ...
  useEffect(() => {
    const fetchVehicles = async () => {
      try {
        const response = await fetch(
          "https://logitrack-serverz.onrender.com/api/vehicles-drivers"
        );
